...
| `fallen.mjs`         | A Dead (11-15) warrior is excluded from all totals/counts and from the PDF/text exports, keeps its equipment as a read-only record in the JSON save, and can be restored. |
